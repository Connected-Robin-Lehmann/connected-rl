    ...
    <footer className="bg-muted/50 border-t">
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            <div className="text-sm text-muted-foreground">
              <p><strong>Inhaber:</strong> Robin Lehmann</p>
              <p><strong>E-Mail:</strong> robin.lehmann2007@gmail.com</p>
              <p><strong>Adresse:</strong> Dürerstraße 10, 69126 Heidelberg</p>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link to="/references" className="text-muted-foreground hover:text-primary transition-colors">
                  Referenzen
                </Link>
              </li>
              <li>
        ...
        <div className="border-t mt-12 pt-8 text-center text-sm text-muted-foreground">
          <p>&copy; {new Date().getFullYear()} Connected - Robin Lehmann. Alle Rechte vorbehalten.</p>
        </div>
      </div>
    </footer>
  );
