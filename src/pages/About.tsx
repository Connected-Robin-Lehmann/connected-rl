          ...
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 md:gap-8 mb-6 md:mb-8">
              <div className="flex items-center space-x-3">
                ...
                <a href="mailto:robin.lehmann@connected-webdesign.de" className="text-sm md:text-base hover:text-primary transition-colors">robin.lehmann@connected-webdesign.de</a>
              </div>
              <div className="flex items-center space-x-3">
